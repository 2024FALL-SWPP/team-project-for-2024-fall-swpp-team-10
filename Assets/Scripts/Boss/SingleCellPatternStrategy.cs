...
public class SingleCellPatternStrategy : IMeteoriteDropStrategy
{
    private Vector3[] patternPositions;

    public SingleCellPatternStrategy(Vector3[] positions)
    {
    ...
    public IEnumerator Execute(BossAttackPattern bossAttackPattern)
    {
        ...
        // 그리드 셀 강조
        bossAttackPattern.HighlightGridCells(patternPositions, Color.red);
